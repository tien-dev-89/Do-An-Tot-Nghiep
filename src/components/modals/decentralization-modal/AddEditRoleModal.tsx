      ...
      <div className="modal-box">
        ...
        <div className="grid gap-4">
          <div className="form-control grid gap-1">
            ...
            <input
              ...
              disabled={!isEditing} // Vô hiệu hóa input khi thêm vai trò
            />
            {error && (
          ...
          <div className="form-control grid gap-1">
            ...
            <textarea
              ...
              disabled={!isEditing} // Vô hiệu hóa textarea khi thêm vai trò
            />
          </div>
        </div>
        <div className="modal-action mt-6">
          ...
          <button
            ...
            onClick={handleSave}
            disabled={!isEditing} // Vô hiệu hóa nút Save khi thêm vai trò
          >
